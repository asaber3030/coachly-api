...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: [require("../../common/entities/meal.entity").Meal] }),
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(user_enum_1.UserRoleEnum.COACH),
    openapi.ApiResponse({ status: 201, type: require("../../common/entities/meal.entity").Meal }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
