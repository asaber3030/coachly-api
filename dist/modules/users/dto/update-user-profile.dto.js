...
class UpdateUserProfileDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { phone: { required: false, type: () => String }, height: { required: false, type: () => Number }, birthDate: { required: false, type: () => String }, gender: { required: false, type: () => String }, avatar: { required: false, type: () => String }, goal: { required: false, type: () => String } };
    }
}
