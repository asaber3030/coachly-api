...
class UpdateRecipeDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String }, description: { required: false, type: () => String }, instructions: { required: false, type: () => String }, calories: { required: false, type: () => Number }, protein: { required: false, type: () => Number }, carbs: { required: false, type: () => Number }, fats: { required: false, type: () => Number }, isGlobal: { required: false, type: () => Boolean } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], UpdateRecipeDto.prototype, "fats", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], UpdateRecipeDto.prototype, "isGlobal", void 0);
